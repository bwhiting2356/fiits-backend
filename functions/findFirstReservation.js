...
exports.findFirstReservation = function (stationDistanceDataList, tripQueryRequest) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                _a.label = 1;
            case 1:
                if (!(checking && stationDistanceDataList.length)) return [3 /*break*/, 5];
                currentStation = stationDistanceDataList.shift();
                return [4 /*yield*/, db_1.Reservation.findAll({
                        where: {
            ...
            case 2:
                ...
                time = addSeconds_1.addSeconds(tripQueryRequest.time, currentStation.walking1Distance.duration);
                request = {
                    currentTime: new Date(),
                    requestTime: time,
                    type: eventType_1.EventType.pickup
                };
                result = testInvAgainstReq_1.testInvAgainstReq(reservations, currentStation.station, request);
                if (!result) return [3 /*break*/, 4];
                checking = false;
                return [4 /*yield*/, db_1.Reservation.create({
...
//# sourceMappingURL=findFirstReservation.js.map