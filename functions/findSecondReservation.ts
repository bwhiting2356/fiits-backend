...
export const findSecondReservation = async (
    stationDistanceDataList: StationDistanceData[],
    reservation1): Promise<ReservationResponse> => {
    ...
    while (checking && stationDistanceDataList.length) {
        ...
        let time = addSeconds(reservation1.time, currentStation.byciclingDistance.duration);
